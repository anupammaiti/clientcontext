...
if (!CQ_Analytics.LocationStoreMgr ) {
    ...
    CQ_Analytics.LocationStoreMgr = CQ_Analytics.JSONStore.registerNewInstance("locationstore");
    ...
    CQ_Analytics.LocationStoreMgr.updateLocation = function() {
        ...
        $('#location-store-data').text("Temperature at "+CQ_Analytics.LocationStoreMgr.data.CURRENT_LOCATION+" is "+CQ_Analytics.LocationStoreMgr.data.CURRENT_TEMPERATURE+" Deg Celsius");
        return false;
    }
}
